...
const CHARACTERS = {
  ...
  greeter: {
    ...
    intro: (name) => {
      const lines = [
        "어서 오세요! 우주입니다. 무엇을 도와드릴까요?",
        "안녕하세요, 우주예요. 필요하신 게 있으면 편하게 말씀해 주세요.",
...
function setCurrentCharacter(key) {
  ...
  // Live2D 활성화 플래그 설정
  window._live2dActive = true; // 야옹이/우주 모두 Live2D
...
window.handleUserSubmit = async function handleUserSubmit() {
      ...
      __wakeNames.push("야옹이", "야옹이야", "야옹아", "얘", "야", "저기", "있잖아", "잠깐");
